...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/geoff/mie443_ws/src/gscam)
  set(gscam_DEVEL_PREFIX /home/geoff/mie443_ws/devel)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/geoff/mie443_ws/install)
...
if(NOT "/home/geoff/mie443_ws/src/gscam/include;/usr/include/gstreamer-0.10;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include;/usr/include/libxml2 " STREQUAL " ")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/home/geoff/mie443_ws/src/gscam/include;/usr/include/gstreamer-0.10;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include;/usr/include/libxml2")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/geoff/mie443_ws/src/gscam/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>' to fix it.")
    endif()
